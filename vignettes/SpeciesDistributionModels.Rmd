...
description: >
  Creating and understanding the Species Distribution Model required for EnvironmentalBasedSample.
---
...
```{r save sdmodel for getting started vignette, echo =F, eval=F}
...
```{r Explore SDM output - Different alpha}sdModel$CVStructure
