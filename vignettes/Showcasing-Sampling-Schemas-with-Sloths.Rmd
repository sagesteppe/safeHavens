...
```{r Grid and Point Based Samples, warning = FALSE}
...
obby <- EcoregionBasedSample(x_buff, neo_eco, OmernikEPA = FALSE, ecoregion_col = 'Provincias')

ggplot() + 
  geom_sf(data = obby, aes(fill = n)) 
