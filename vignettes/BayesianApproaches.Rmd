...
```{r download data, echo = FALSE, message=F}
...
```{r show posterior clusters, warning=F,message=F}
bmap +
...
```{r, plot predictive provenance, message=F}
...
```{r posterior predicted probabilities,warning=F,message=F}
loo_probs <- tibble(
