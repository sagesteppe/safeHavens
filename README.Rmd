...
description: "R package providing seven sampling schemes for germplasm curators to prioritize field collection efforts for ex situ plant conservation"
---
...
cat(
  ...
  badger::badge_github_actions("sagesteppe/safeHavens", "R-CMD-check"), "\n"
)
```
...
The following table shows the seven sampling approaches available in safeHavens, with their computational complexity (Comp.) and environmental data requirements (Envi.): L = Low, M = Medium, H = High.
