...
#' @export
EnvironmentalBasedSample <- function(pred_rescale, f_rasts, lyr = 'Supplemented', taxon, path = '.', n = 20, fixedClusters = TRUE, n_pts = 500, 
  planar_proj, coord_wt = 2.5, buffer_d = 3, prop_split = 0.8, write2disk = FALSE,  ...){
