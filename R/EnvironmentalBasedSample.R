...
#' @export
EnvironmentalBasedSample <- function(pred_rescale, f_rasts, lyr, taxon, path, n, fixedClusters, n_pts, planar_projection, coord_wt, buffer_d, prop_split, write2disk,  ...){
  
  if(missing(path)){path <- '.'}
  if(missing(write2disk)){write2disk <- FALSE}
